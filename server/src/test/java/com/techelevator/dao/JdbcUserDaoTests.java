...
public class JdbcUserDaoTests extends BaseDaoTests {
    protected static final User USER_1 = new User(1, "user1", "user1", "ROLE_USER", "Artist");
    protected static final User USER_2 = new User(2, "user2", "user2", "ROLE_USER", "Manager");
    private static final User USER_3 = new User(3, "user3", "user3", "ROLE_USER", "Artist");
    ...
    public void create_user_with_null_username() {
        dao.createUser(new User(null, USER_3.getHashedPassword(), "ROLE_USER", "Artist"));
    }

    @Test(expected = DaoException.class)
    public void create_user_with_existing_username() {
        dao.createUser(new User(USER_1.getUsername(), USER_3.getHashedPassword(), "ROLE_USER", "Artist"));
    }

    @Test(expected = DaoException.class)
    public void create_user_with_null_password() {
        dao.createUser(new User(USER_3.getUsername(), null, "ROLE_USER", "Artist"));
    }

    @Test
    public void create_user_creates_a_user() {

        User newUser = new User("new-user", "user", "ROLE_USER", "Manager");
